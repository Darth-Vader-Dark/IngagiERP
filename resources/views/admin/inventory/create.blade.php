                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route("admin.inventory.store") }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="stock_qty" class="block mt-1 w-full" type="number" name="stock_qty" :value="old("stock_qty")" required min="0" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="qr_code_value" class="block mt-1 w-full" type="text" name="qr_code_value" :value="old("qr_code_value")" />
